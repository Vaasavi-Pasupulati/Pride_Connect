    ...
    <div className={styles.container}>
      <div className={styles.left}>
        <div className={styles.row}>
          <table className={styles.table}>
            ...
            <tr className={styles.tr}>
              ...
              <td>
                <span className={styles.name}>Rehan Sharma</span>
              </td>
              {/* <td> <span className={styles.address}>New Delhi</span> </td> */}
              <td>
                <span className={styles.total}>₹18000</span>
              </td>
            </tr>
          </table>
        </div>
        <div className={styles.row}>
          ...
          <div className={statusClass(0)}>
            <Image src="/img/confirmed.png" width={30} height={30} alt="" />
